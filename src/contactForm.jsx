...
export default class ContactForm extends React.Component {
  ...
  handleSubmit(event) {
    ...
    console.log(`A form was submitted: ${name} <${email}>`)
    event.preventDefault()
  }

  render() {
    const { name, email, phone, object, message } = this.state
    return (
          ...
          <form onSubmit={this.handleSubmit}>
            <FlexOuter>
              ...
              <li>
                ...
                <input name="object" type="text" value={object} onChange={this.handleChange} />
              </li>
              <li>
